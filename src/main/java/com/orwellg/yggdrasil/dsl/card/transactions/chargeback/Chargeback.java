...
public class Chargeback {
    ...
    private static final Logger LOG = LogManager.getLogger(Chargeback.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ChargebackTopology topology = new ChargebackTopology();
    ...
    private static Config config() {
        TopologyConfig config = TopologyConfigFactory.getTopologyConfig(ChargebackTopology.PROPERTIES_FILE);
