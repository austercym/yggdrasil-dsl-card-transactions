...
public class GpsMessage {
    ...
    public com.yggdrasil.dsl.card.transactions.FeeTransactionType getFeeTransactionType() {
        return FeeTransactionType;
    }

    public void setFeeTransactionType(com.yggdrasil.dsl.card.transactions.FeeTransactionType feeTransactionType) {
